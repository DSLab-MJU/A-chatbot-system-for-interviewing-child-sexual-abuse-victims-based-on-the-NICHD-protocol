...
def KoBERT_NER(model_file_name, model_name, intent_train, intent_train_target, intent_val, intent_val_target, intent_test, intent_test_target, epoch):
    best_valid_loss= 10
    epochs = epoch
...
KoBERT_NER("KoBERT_NER_Original_epoch10_v1", "KoBERT", ori_question, ori_question_target, val_question, val_question_target, test_question, test_question_target, 10)
KoBERT_NER("KoBERT_NER_EDA10_epoch10_v1", 'KoBERT', EDA_10_question, EDA_10_question_target, val_question, val_question_target, test_question, test_question_target, 10)
KoBERT_NER("KoBERT_NER_EDA20_epoch10_v1", 'KoBERT', EDA_20_question, EDA_20_question_target, val_question, val_question_target, test_question, test_question_target, 10)
KoBERT_NER("KoBERT_NER_EDA30_epoch10_v1", 'KoBERT', EDA_30_question, EDA_30_question_target, val_question, val_question_target, test_question, test_question_target, 10)
KoBERT_NER("KoBERT_NER_EMB10_epoch10_v1", 'KoBERT', EMB_10_question, EMB_10_question_target, val_question, val_question_target, test_question, test_question_target, 10)
KoBERT_NER("KoBERT_NER_EMB20_epoch10_v1", 'KoBERT', EMB_20_question, EMB_20_question_target, val_question, val_question_target, test_question, test_question_target, 10)
KoBERT_NER("KoBERT_NER_EMB30_epoch10_v1", 'KoBERT', EMB_30_question, EMB_30_question_target, val_question, val_question_target, test_question, test_question_target, 10)
